...
# Minimum set
parainfm = c(0.07,0.05,59,0.35) #c(0.2,0.1,90,0.5) #c(0.025, 0.0005, 22, 0.5)
...
#sd_fits = read.csv("bi30_fp1_sdfits_10000.csv")[1,2:5]
sd_fits = read.csv("bi_fp1_sdfits_big.csv")[1,2:5]

# How many want to run? 
nruns = 5000
out_mcmc <- peru_mcmc(dist_peru_data_fp1, parainfm, sd_fits, nruns)
write.csv(out_mcmc,paste("bi_fp1_out_mcmc_",nruns,"_",args[1],".csv",sep=""))
...
write.csv(fits,paste("bi_fp1_fits_",nruns,"_",args[1],".csv",sep=""))
write.csv(sd_fits,paste("bi_fp1_sdfits_",nruns,"_",args[1],".csv",sep=""))
