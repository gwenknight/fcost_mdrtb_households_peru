...
## Read in all unique
fp2_u <- read.csv("bi_fp2_unique_all_fits.csv")[,-1]
...
write.csv(store,paste("bi_fp2_store_",args[1],".csv",sep=""))


if(fitt == 1){write.csv(summary_fit,paste("bi_fp2_summary_fit_",args[1],".csv",sep=""));
              write.csv(kp,paste("bi_fp2_kp_",args[1],".csv",sep=""))} # only keep summary and kp if fit
