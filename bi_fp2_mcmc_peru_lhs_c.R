...
out_mcmc_lhs <- peru_mcmc_lhs(dist_peru_data_fp2, parainfm, sd_fits, nruns)
write.csv(out_mcmc_lhs,paste("bi_fp2_out_mcmc_lhs",nruns,".csv",sep=""))
...
write.csv(fits,paste("bi_fp2_fits_",nruns,".csv",sep=""))
write.csv(sd_fits,paste("bi_fp2_sdfits_",nruns,".csv",sep=""))
