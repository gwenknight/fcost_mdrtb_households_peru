...
write.csv(out_mcmc_lhs,paste("bi_fp1_out_mcmc_lhs",nruns,".csv",sep=""))
...
write.csv(fits,paste("bi_fp1_fits_",nruns,".csv",sep=""))
write.csv(sd_fits,paste("bi_fp1_sdfits_",nruns,".csv",sep=""))
