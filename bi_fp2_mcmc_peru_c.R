...
sd_fits = read.csv("bi_fp2_sdfits_10000.csv")[1,2:5]

# How many want to run? 
nruns = 5000
out_mcmc <- peru_mcmc(dist_peru_data_fp2, parainfm, sd_fits, nruns)
write.csv(out_mcmc,paste("bi_fp2_out_mcmc_",nruns,"_",args[1],".csv",sep=""))
...
write.csv(fits,paste("bi_fp2_fits_",nruns,"_",args[1],".csv",sep=""))
write.csv(sd_fits,paste("bi_fp2_sdfits_",nruns,"_",args[1],".csv",sep=""))
