...
out_mcmc_lhs <- peru_mcmc_lhs(dist_peru_data_fp1, parainfm, sd_fits, nruns)
write.csv(out_mcmc_lhs,paste("bi30_fp1_out_mcmc_lhs",nruns,".csv",sep=""))
...
write.csv(fits,paste("bi30_fp1_fits_",nruns,".csv",sep=""))
write.csv(sd_fits,paste("bi30_fp1_sdfits_",nruns,".csv",sep=""))
